...
export class TableComponent implements OnInit, OnChanges {
  ...
  @Output() trendViewOnDataClick: EventEmitter<any> = new EventEmitter<any>();
  ...
  public trendView(tableData){
    let emittedData: any = { table: tableData };
    this.trendViewOnDataClick.emit(emittedData);
  }
}

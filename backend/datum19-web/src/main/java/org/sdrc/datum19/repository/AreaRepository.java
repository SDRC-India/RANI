...
public interface AreaRepository extends MongoRepository<Area, String>{
	...
	List<Area> findByAreaIdIn(List<Integer> areaId);
	
	List<Area> findByAreaLevelAreaLevelId(Integer areaLevelId);

	List<Area> findByParentAreaIdAndAreaLevelAreaLevelId(Integer parentAreaId, Integer i);
	
	Area findByAreaCode(String areaCode);

	List<Area> findByAreaCodeIn(List<String> childAreaCodes);

...
//	public List<TimePeriod> findTop5ByPeriodicityAndFinancialYearOrderByCreatedDateDesc(String string, String monthlyFinancialYear);
	...
	public TimePeriod findById(Integer tpId);

	public List<TimePeriod> findTop6ByPeriodicityOrderByCreatedDateDesc(String periodiciyOfInd);

	public TimePeriod findByTimePeriodDuration(String string);

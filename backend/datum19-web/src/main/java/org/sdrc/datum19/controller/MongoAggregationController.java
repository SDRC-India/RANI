...
import org.sdrc.datum19.service.CumulativeAggregationService;
...
public class MongoAggregationController {
	...
	@Autowired
	private CumulativeAggregationService cumulativeAggregationService;
	
	@Autowired
	private IndicatorRepository ir;
	...
	@GetMapping("/aggregateCumulativeData")
	public String aggregateCumulativeData() {
		cumulativeAggregationService.aggregateCumulativeData();
		return "completed";
	}
	
//	@GetMapping("/testLanguageSearch")
//	public Indicator testLanguageSearch(@RequestParam("searchText") String searchText) {
//		Indicator in=ir.searchIndicator(searchText);
//		return in;
//	}
}
